...
-- Note: PRAGMA statements are set at connection time in database.go
-- Note: Not using STRICT mode to allow JSON columns (stored as TEXT)
...
-- Note: schema_migrations table is managed by the migration runner in Go
